    ...
    return (
        <>
            ...
            <Col className="m-5 p-lg-4">
                <h1 className="text-2 mb-5 mt-3">You can help by Donating!</h1>
                <Card border="info">
                    <Card.Title className="p-3 bg-info text-white">
                        <Row>
                            <div className="mx-auto">Let us know the cause!</div>
                        </Row>
                    </Card.Title>
                            ...
                            <Container className="mt-lg-2">
                                <Row>
                                    <Button className="mx-auto btn-lg" variant="info" type="submit">
                                        Proceed to Payment! <i className="fas fa-paper-plane" />
                                    </Button>
                                </Row>
                            </Container>
                        </Form>
